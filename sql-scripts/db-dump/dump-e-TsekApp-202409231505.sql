...
--
-- Host: localhost    Database: e-TsekApp
-- ------------------------------------------------------
...
--
-- Table structure for table `a_assess_red_flags`
--

DROP TABLE IF EXISTS `a_assess_red_flags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_assess_red_flags` (
  `ard_id` varchar(50) NOT NULL,
  `patient_id` varchar(50) DEFAULT NULL,
  `ard_chest_pain` char(3) DEFAULT NULL,
  `ard_difficulty_breathing` char(3) DEFAULT NULL,
  `ard_loss_consciousness` char(3) DEFAULT NULL,
  `ard_slurred_speech` char(3) DEFAULT NULL,
  `ard_facial_asymmetry` char(3) DEFAULT NULL,
  `ard_numb_arm` char(3) DEFAULT NULL,
  `ard_disoriented` char(3) DEFAULT NULL,
  `ard_chest_retractions` char(3) DEFAULT NULL,
  `ard_seizure_or_convulsion` char(3) DEFAULT NULL,
  `ard_selfharm_or_suicide` char(3) DEFAULT NULL,
  `ard_aggressive_behavior` char(3) DEFAULT NULL,
  `ard_eye_injury` char(3) DEFAULT NULL,
  `ard_severe_injuries` char(3) DEFAULT NULL,
  PRIMARY KEY (`ard_id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `a_assess_red_flags_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `a_patient_info` (`patient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a_assess_red_flags`
--

LOCK TABLES `a_assess_red_flags` WRITE;
/*!40000 ALTER TABLE `a_assess_red_flags` DISABLE KEYS */;
,558,0),
...
(5951,8,204,'Barangay 71',NULL,NULL,NULL)/*!40000 ALTER TABLE `a_brgy_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_consultation_logs`
--

DROP TABLE IF EXISTS `a_consultation_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_consultation_logs` (
  `cl_id` varchar(50) NOT NULL,
  `cl_description` text DEFAULT NULL,
  `cl_date` date NOT NULL,
  `patient_id` varchar(50) DEFAULT NULL,
  `officer_id` varchar(50) DEFAULT NULL,
  `hf_id` varchar(50) DEFAULT NULL,
  ...
  KEY `ref_id` (`ref_id`),
  KEY `hf_id` (`hf_id`),
  CONSTRAINT `a_consultation_logs_ibfk_1` FOREIGN KEY (`officer_id`) REFERENCES `a_officer_info` (`officer_id`),
  CONSTRAINT `a_consultation_logs_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `a_patient_info` (`patient_id`),
  CONSTRAINT `a_consultation_logs_ibfk_3` FOREIGN KEY (`ref_id`) REFERENCES `a_referral` (`ref_id`),
  CONSTRAINT `a_consultation_logs_ibfk_4` FOREIGN KEY (`cl_id`) REFERENCES `a_consultation_logs` (`cl_id`),
  CONSTRAINT `a_consultation_logs_ibfk_5` FOREIGN KEY (`hf_id`) REFERENCES `a_health_facility_info` (`hf_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a_consultation_logs`
--

LOCK TABLES `a_consultation_logs` WRITE;
/*!40000 ALTER TABLE `a_consultation_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_consultation_logs` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_family_history`
--

DROP TABLE IF EXISTS `a_family_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_family_history` (
  `fh_id` varchar(50) NOT NULL,
  `patient_id` varchar(50) DEFAULT NULL,
  `fh_hypertension` char(3) DEFAULT NULL,
  `fh_stroke` char(3) DEFAULT NULL,
  `fh_heart_disease` char(3) DEFAULT NULL,
  `fh_diabetes_mellitus` char(3) DEFAULT NULL,
  `fh_asthma` char(3) DEFAULT NULL,
  `fh_cancer` char(3) DEFAULT NULL,
  `fh_kidney_disease` char(3) DEFAULT NULL,
  `fh_vascular_disease` char(3) DEFAULT NULL,
  `fh_tb` char(3) DEFAULT NULL,
  `fh_disorders` char(3) DEFAULT NULL,
  `fh_copd` char(3) DEFAULT NULL,
  PRIMARY KEY (`fh_id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `a_family_history_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `a_patient_info` (`patient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a_family_history`
--

LOCK TABLES `a_family_history` WRITE;
/*!40000 ALTER TABLE `a_family_history` DISABLE KEYS */;
H OFFICE','','Anibongan',428,'Duero',22,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000072','TRINIDAD RURAL HEALTH UNIT','','Poblacion',990,'Trinidad',45,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000073','JAGNA RURAL HEALTH UNIT I','','Poblacion (pondol)',575,'Jagna',26,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000074','SAN MIGUEL MUNICIPAL HEALTH OFFICE','','Garcia',882,'San Miguel',39,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000206','MABINI RURAL HEALTH UNIT AND BIRTHING CENTER','','Poblacion I',753,'Mabini',32,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000219','TORIBIA BADILLA-EVASCO MEMORIAL HEALTH CENTER','','Poblacion',776,'Maribojoc',33,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000220','DIMIAO MUNICIPAL INFIRMARY','','Sawang',421,'Dimiao',21,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000221','BARILI DISTRICT HOSPITAL','','Poblacion',1339,'Barili',58,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000223','CANLAON DISTRICT HOSPITAL','','Bayog',3130,'Canlaon City',139,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000000224','DAANBANTAYAN DISTRICT HOSPITAL','','Pajo',1660,'Daanbantayan',71,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000225','OSLOB DISTRICT HOSPITAL','','Lagunde',1956,'Oslob',84,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000233','TOLEDO CITY GENERAL HOSPITAL','','Poblacion',2241,'Toledo City',99,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000234','BINDOY DISTRICT HOSPITAL','','Poblacion (Payabon)',3125,'Bindoy (Payabon)',138,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000000244','SANTA ROSA COMMUNITY HOSPITAL','','Santa Rosa',1818,'Lapu-lapu City (opon)',76,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000264','CONG. SIMEON G. TORIBIO MEMORIAL HOSPITAL','','Poblacion Sur',273,'Carmen',13,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000268','DAVAO REGIONAL MEDICAL CENTER','','Apokon',NULL,'Tagum',NULL,'Davao del Norte',NULL,'11','','','','','','','','','',''),
('DOH000000000000276','DR. PAULINO J. GARCIA MEMORIAL RESEARCH AND MEDICAL CENTER','','',NULL,'City of Cabanatuan',NULL,'Nueva Ecija',NULL,'3','','','','','','','','','',''),
('DOH000000000000300','DR. ILDEFONSO ALCANTARA MEMORIAL HOSPITAL','','Poblacion',1694,'Dalaguete',72,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000379','TAGBILARAN COMMUNITY HOSPITAL CORP.','','Poblacion Iii',947,'Tagbilaran City (Capital)',43,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000414','ADVENTIST MEDICAL CENTER - BACOLOD, INC.','','Taculing',4225,'City of Bacolod',332,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000000453','CLINICA GATCHALIAN AND HOSPITAL','','Barangay 26',5465,'Ormoc City',195,'Leyte',8,'8','','','','','','','','','',''),
('DOH000000000000464','CEBU PROVINCIAL HOSPITAL (DANAO CITY)','','Suba',1737,'Danao City',73,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000494','DR. GUMERSINDO GARCIA SR MEMORIAL HOSPITAL','','Barangay 5',3853,'City of Kabankalan',309,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000000512','DR. PABLO O. TORRE MEMORIAL HOSPITAL','','Barangay 5',4175,'City of Bacolod',332,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000000540','EAST AVENUE MEDICAL CENTER','','',NULL,'City of Quezon',NULL,'Metro Manila',NULL,'NCR','','','','','','','','','',''),
('DOH000000000000544','ELEUTERIO T. DECENA MEMORIAL HOSPITAL','','Po-ok',3799,'Hinoba-an',317,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000000545','FRANCISCO DAGOHOY MUNICIPAL HOSPITAL','','Cawayan',507,'Inabanga',25,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000583','CEBU PROVINCIAL HOSPITAL (CARCAR CITY)','','Poblacion Ii',1541,'City Of Carcar',65,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000591','KABANKALAN CITY HOSPITAL','','Binicuil',3858,'City of Kabankalan',309,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000000625','LORENZO D. ZAYCO DISTRICT HOSPITAL','','Binicuil',3858,'City of Kabankalan',309,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000000637','MAKATI MEDICAL CENTER','','',NULL,'City of Makati',NULL,'Metro Manila',NULL,'NCR','','','','','','','','','',''),
('DOH000000000000744','AMOSUP SEAMEN\'S HOSPITAL - CEBU','','Umapad',1891,'Mandaue City',80,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000761','ST. ELIZABETH HOSPITAL, INC.','','',NULL,'City of General Santos',NULL,'South Cotabato',NULL,'12','','','','','','','','','',''),
('DOH000000000000777','SAINT VINCENT GENERAL HOSPITAL CEBU, INC.','','Sambag I (Pob.)',1478,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000836','COMPOSTELA RURAL HEALTH UNIT','','Poblacion',1609,'Compostela',68,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000000845','DIMIAO RURAL HEALTH UNIT','','Luyo',415,'Dimiao',21,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000000903','SANTANDER RURAL HEALTH UNIT','','Poblacion',2132,'Santander',94,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001388','CORTES RURAL HEALTH UNIT','','Poblacion',342,'Cortes',17,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000001438','LILOAN RURAL HEALTH UNIT','','Poblacion',1830,'Liloan',77,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001439','PORO RURAL HEALTH UNIT','','Eastern Poblacion',2010,'Poro',87,'Camotes',6,'7','','','','','','','','','',''),
('DOH000000000001448','ASTURIAS RURAL HEALTH UNIT','','Poblacion',1212,'Asturias',54,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001450','BARILI RURAL HEALTH UNIT II','','Poblacion',1339,'Barili',58,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001451','DALAGUETE RURAL HEALTH UNIT II','','Mantalongon',1694,'Dalaguete',72,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001454','BARILI RURAL HEALTH UNIT I','','Poblacion',1339,'Barili',58,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001458','BORBON RURAL HEALTH UNIT','','Poblacion',1371,'Borbon',60,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001459','TUBURAN RURAL HEALTH UNIT II','','Mangga',2293,'Tuburan',100,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001460','VICENTE MENDIOLA CENTER FOR HEALTH','','Central Poblacion',1551,'City of Naga',66,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001461','TUDELA RURAL HEALTH UNIT','','Southern Poblacion',2314,'Tudela',101,'Camotes',6,'7','','','','','','','','','',''),
('DOH000000000001465','MINGLANILLA RURAL HEALTH UNIT I','','Poblacion Ward Iv',1923,'Minglanilla',82,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001490','PANGLAO RURAL HEALTH UNIT','','Poblacion',791,'Panglao',34,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000001491','DANAO CITY HEALTH OFFICE','','Poblacion',1728,'Danao City',73,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001492','BAYAWAN CITY HEALTH OFFICE','','Tinago (Pob.)',3166,'City of Bayawan (Tulong)',140,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000001494','MANDAUE CITY HEALTH OFFICE','','Centro (pob.)',1874,'Mandaue City',80,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001496','ARGAO RURAL HEALTH UNIT II','','Lamacan',1174,'Argao',53,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001662','AMIO COMMUNITY PRIMARY HOSPITAL','','Amio',3424,'Santa Catalina',151,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000001666','INAPOY COMMUNITY PRIMARY HOSPITAL','','Inapoy',3865,'City of Kabankalan',309,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000001667','PRESIDENT CARLOS P. GARCIA MUNICIPAL HOSPITAL','','Poblacion',828,'Pres. Carlos P. Garcia (pitogo)',36,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000001669','MARIANO JESUS CUENCO MEMORIAL HOSPITAL','','Montañeza (inamlang)',1860,'Malabuyoc',79,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001671','ISIDRO KINTANAR MEMORIAL HOSPITAL','','Bogo',1157,'Argao',53,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001685','CARMEN COPPER CORPORATION HOSPITAL','','Don Andres Soriano (lutopan)',2229,'Toledo City',99,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001689','ADVENTIST HOSPITAL - CEBU, INC.','','San Nicolas Central',1483,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001690','CONCEPCION MEMORIAL HOSPITAL','','Canmanico',1086,'Valencia',48,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000001810','SAN MIGUEL HOSPITAL','','Poblacion',886,'San Miguel',39,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000001864','CLARIN COMMUNITY HOSPITAL','','Poblacion Norte',319,'Clarin',15,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000001891','BAYAWAN DISTRICT HOSPITAL','','Poblacion',3158,'City of Bayawan (Tulong)',140,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000001897','MINGLANILLA RURAL HEALTH UNIT II','','Poblacion Ward I',1920,'Minglanilla',82,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001948','BOGO-MEDELLIN MEDICAL CENTER','','Luy-a',1905,'Medellin',81,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000001983','RONDA RURAL HEALTH UNIT','','Canduling',2024,'Ronda',88,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002019','CANLAON CITY HEALTH OFFICE','','Panubigan',3140,'Canlaon City',139,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000002030','ENRIQUE VILLANUEVA RURAL HEALTH UNIT','','Poblacion',2885,'Enrique Villanueva',127,'Siquijor',4,'8','','','','','','','','','',''),
('DOH000000000002032','SAMBOAN RURAL HEALTH UNIT','','Poblacion',2047,'Samboan',89,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002035','HOLY CHILD HOSPITAL','','Poblacion No. 3 (Barangay 3)',3564,'Dumaguete City (Capital) ',144,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000002172','PERPETUAL SUCCOUR HOSPITAL OF CEBU, INC.','','Camputhaw (pob.)',1438,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002183','BACLAYON RURAL HEALTH UNIT','','Poblacion',74,'Baclayon',5,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000002257','CHONG HUA HOSPITAL','','Capitol Site (pob.)',1439,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002396','LA LIBERTAD RURAL HEALTH UNIT','','Poblacion South',3329,'La Libertad',146,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000002419','BANTAYAN DISTRICT HOSPITAL','','Binaobao (Pob.)',1283,'Bantayan',57,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002435','CANDIJAY COMMUNITY HOSPITAL','','Poblacion',244,'Candijay',12,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000002449','ARGAO RURAL HEALTH UNIT I','','Poblacion',1184,'Argao',53,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002467','SAN ISIDRO RURAL HEALTH UNIT','','Poblacion',873,'San Isidro',38,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000002468','SIQUIJOR RURAL HEALTH UNIT','','Poblacion',2995,'Siquijor (Capital)',132,'Siquijor',4,'8','','','','','','','','','',''),
('DOH000000000002469','LAPU-LAPU CITY HEALTH OFFICE','','Pusok',1815,'Lapu-lapu City (opon)',76,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002495','SAN CARLOS DOCTORS\' HOSPITAL','','Barangay I',4045,'City of San Carlos',312,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000002541','VALLEHERMOSO RURAL HEALTH UNIT','','Poblacion',3548,'Vallehermoso',156,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000002662','AYUNGON RURAL HEALTH UNIT','','Poblacion',3035,'Ayungon',134,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000002673','BACONG RURAL HEALTH UNIT','','North Poblacion',3054,'Bacong',135,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000002683','TUBIGON RURAL HEALTH UNIT I','','Potohan',1024,'Tubigon',46,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000002691','ORMOC DISTRICT HOSPITAL','','Cogon Combado',5488,'Ormoc City',195,'Leyte',8,'8','','','','','','','','','',''),
('DOH000000000002706','MARIBOJOC COMMUNITY HOSPITAL','','Bayacabac',765,'Maribojoc',33,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000002718','SANTA FE RURAL HEALTH UNIT','','Poblacion',2121,'Santa Fe',93,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002778','MACTAN DOCTORS HOSPITAL, INC.','','Basak',1797,'Lapu-lapu City (opon)',76,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002786','TUBURAN RURAL HEALTH UNIT I','','Barangay Iii (pob.)',2261,'Tuburan',100,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002841','SIBULAN RURAL HEALTH UNIT','','Poblacion',3482,'Sibulan',153,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000002890','CONSOLACION RURAL HEALTH UNIT','','Poblacion Occidental',1625,'Consolacion',69,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002892','VALENCIA (LUZURRIAGA) RURAL HEALTH UNIT','','North Poblacion',3532,'Valencia (Luzurriaga) ',155,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000002930','CEBU SOUTH GENERAL HOSPITAL','','Tuyan',1571,'City of Naga',66,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000002964','LILA RURAL HEALTH UNIT','','Catugasan',608,'Lila',28,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000002990','CEBU DOCTORS\' UNIVERSITY HOSPITAL INC.','','Camputhaw (pob.)',1438,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003006','SAN JOSE RURAL HEALTH UNIT','','Poblacion',3416,'San Jose',150,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000003022','UBAY RURAL HEALTH UNIT II','','San Pascual',1063,'Ubay',47,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000003050','VISAYAS MED-CEBU','','Santa Cruz (pob.)',1484,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003095','SIQUIJOR PROVINCIAL HOSPITAL','','Pangi',2991,'Siquijor (Capital)',132,'Siquijor',4,'8','','','','','','','','','',''),
('DOH000000000003128','TANJAY CITY HEALTH UNIT I','','Poblacion VII (Barangay 7)',3217,'City of Tanjay',142,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000003129','CARCAR RURAL HEALTH UNIT I','','Poblacion Ii',1541,'City Of Carcar',65,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003131','PACUAN COMMUNITY PRIMARY HOSPITAL','','Pacuan',3324,'La Libertad',146,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000003151','BASAY RURAL HEALTH UNIT','','Poblacion',3107,'Basay',137,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000003207','TALIBON MUNICIPAL HEALTH CENTER','','Poblacion',962,'Talibon',44,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000003228','BOGO CITY HEALTH OFFICE','','Gairan',1512,'City of Bogo',64,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003245','MEDELLIN RURAL HEALTH UNIT','','Poblacion',1909,'Medellin',81,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003278','LUZ-SIKATUNA COMMUNITY PRIMARY HOSPITAL','','Luz',3186,'City Of Guihulngan ',141,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000003368','BALILIHAN MUNICIPAL HEALTH OFFICE','','Del Carmen Este (Pob.)',94,'Balilihan',6,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000003407','CEBU PROVINCIAL HOSPITAL (BOGO CITY)','','Taytayan',1530,'City of Bogo',64,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003438','LOON RURAL HEALTH UNIT II','','Catagbacan Handig',705,'Loon',31,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000003443','DAUIS MUNICIPAL HEALTH OFFICE','','Poblacion',385,'Dauis',20,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000003535','GUIHULNGAN CITY HEALTH OFFICE I','','Poblacion',3196,'City Of Guihulngan ',141,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000003536','JIMALALUD RURAL HEALTH UNIT','','South Poblacion',3302,'Jimalalud',145,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000003539','LAZI HEALTH CENTER','','Catamboan (pob.)',2914,'Lazi',129,'Siquijor',4,'8','','','','','','','','','',''),
('DOH000000000003665','CANDIJAY RURAL HEALTH UNIT','','Poblacion',244,'Candijay',12,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000003830','SAN REMIGIO RURAL HEALTH UNIT I','','Poblacion',2106,'San Remigio',92,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003846','SOGOD RURAL HEALTH UNIT','','Poblacion',2174,'Sogod',96,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003915','TOLEDO CITY HEALTH DEPARTMENT','','Ilihan',2233,'Toledo City',99,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003945','LOON RURAL HEALTH UNIT I','','Moto Sur (Pob.)',717,'Loon',31,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000003949','DALAGUETE RURAL HEALTH UNIT I','','Poblacion',1694,'Dalaguete',72,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003973','GOV. WILLIAM (BILLY) VILLEGAS MEMORIAL HOSPITAL','','Poblacion',3196,'City Of Guihulngan ',141,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000003983','KALUMBOYAN COMMUNITY PRIMARY HOSPITAL','','Narra',3156,'City Of Bayawan (Tulong) ',140,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000003993','TUBURAN DISTRICT HOSPITAL','','Barangay Viii (pob.)',2265,'Tuburan',100,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000003997','SAN CARLOS CITY HOSPITAL','','Rizal',4030,'City of San Carlos',312,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000004009','CEBU PROVINCIAL HOSPITAL (BALAMBAN)','','Buanoy',1258,'Balamban',56,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004045','ANDA RURAL HEALTH UNIT AND BIRTHING CENTER','','Poblacion',36,'Anda',3,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004072','LAPU-LAPU CITY HOSPITAL','','Gun-ob',1804,'Lapu-lapu City (opon)',76,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004142','SIERRA BULLONES RURAL HEALTH UNIT','','Poblacion',919,'Sierra Bullones',41,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004166','DR. JOSE MA. BORROMEO MEMORIAL HOSPITAL','','Poblacion',1994,'Pinamungahan',86,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004185','CONG. LAMBERTO L. MACIAS MEMORIAL HOSPITAL','','Poblacion III',3463,'Siaton ',152,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000004186','TEODORO B. GALAGAR DISTRICT HOSPITAL','','Poblacion (pondol)',575,'Jagna',26,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004201','MANDAUE CITY HOSPITAL','','Centro (pob.)',1874,'Mandaue City',80,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004296','GARCIA MEMORIAL PROVINCIAL HOSPITAL','','San Jose',969,'Talibon',44,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004299','CORAZON LOCSIN MONTELIBANO MEMORIAL REGIONAL HOSPITAL','','Barangay 9',4179,'City of Bacolod',332,'Negros Occidental',5,'NIR','','','','','','','','','',''),
('DOH000000000004358','SUMC FOUNDATION, INC.','','Daro',3262,'Dumaguete City (Capital) ',144,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000004412','CORDOVA RURAL HEALTH UNIT','','Poblacion',191,'Cordova',70,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004414','ST. ANTHONY MOTHER AND CHILD HOSPITAL','','Basak San Nicolas',1427,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004421','BIEN UNIDO RURAL HEALTH UNIT','','Poblacion (Bien Unido)',138,'Bien Unido',8,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004430','LARENA RURAL HEALTH UNIT AND BIRTHING CENTER','','North Poblacion',2904,'Lazi',129,'Siquijor',4,'8','','','','','','','','','',''),
('DOH000000000004466','GETAFE RURAL HEALTH UNIT','','Poblacion',595,'Jetafe',27,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004473','CAMP LAPULAPU STATION HOSPITAL, CENTCOM, AFP','','Apas',1420,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004479','RICARDO L. MANINGO MEMORIAL HOSPITAL','','North Poblacion',2078,'San Franciso',91,'Camotes',6,'7','','','','','','','','','',''),
('DOH000000000004494','GARCIA HERNANDEZ MUNICIPAL HEALTH OFFICE','','Poblacion East',468,'Garcia Hernandez',23,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004546','MADRIDEJOS RURAL HEALTH UNIT','','Poblacion',1845,'Madridejos',78,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004548','AMLAN (AYUQUITAN) RURAL HEALTH UNIT','','Poblacion',3013,'Amlan (Ayuquitan) ',133,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000004618','MALABUYOC RURAL HEALTH UNIT','','Barangay Ii (Pob.)',1853,'Malabuyoc',79,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004632','DEIPARINE COMMUNITY HOSPITAL','','Poblacion',2154,'Sibonga',95,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004662','TABOGON RURAL HEALTH UNIT','','Poblacion',2194,'Tabogon',97,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004667','DR. LIM\'S CLINIC AND HOSPITAL','','Poblacion Occidental',1103,'Valencia',48,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004705','CEBU NORTH GENERAL HOSPITAL','','Talamban',1495,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004707','ADELA SERRA TY MEMORIAL MEDICAL CENTER','','Telaje',NULL,'Tandag',NULL,'Surigao del Sur',13,'13','','','','','','','','','',''),
('DOH000000000004734','OSLOB RURAL HEALTH UNIT','','Poblacion',1962,'Oslob',84,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004780','BUENAVISTA RURAL HEALTH UNIT','','Poblacion',191,'Buenavista',10,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004899','ANTEQUERA RURAL HEALTH UNIT','','Poblacion',55,'Antequera',4,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000004950','BAIS CITY HEALTH OFFICE','','Barangay I (Pob.)',3063,'Bais City',136,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000004951','PINAMUNGAHAN RURAL HEALTH UNIT','','Poblacion',1994,'Pinamungahan',86,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000004953','SIBONGA RURAL HEALTH UNIT','','Poblacion',2154,'Sibonga',95,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000005001','ALICIA RURAL HEALTH UNIT AND BIRTHING CENTER','','Poblacion (Calingganay)',22,'Alicia',2,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000005127','ADVENTIST MEDICAL CENTER - VALENCIA CITY, INC.','','Poblacion',NULL,'Valencia',NULL,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000005163','PRESIDENT CARLOS GARCIA MUNICIPAL HEALTH OFFICE','','Tugnao',836,'Pres. Carlos P. Garcia (pitogo)',36,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000005218','TALISAY RURAL HEALTH UNIT I','','Poblacion',1589,'City of Talisay ',67,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000005273','CEBU (VELEZ) GENERAL HOSPITAL, INC.','','Cogon Ramos (pob.)',1443,'Cebu City (Capital)',63,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000005280','CEBU SOUTH MEDICAL CENTER','','San Isidro',1591,'City of Talisay ',67,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000005284','TUBIGON COMMUNITY HOSPITAL','','Potohan',1024,'Tubigon',46,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000005321','DAANBANTAYAN RURAL HEALTH UNIT I','','Poblacion',1662,'Daanbantayan',71,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000005353','DON EMILIO DEL VALLE MEMORIAL HOSPITAL','','Bood',1036,'Ubay',47,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000005356','DAUIN RURAL HEALTH UNIT','','Poblacion II',3246,'Dauin',143,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000005373','ALBURQUERQUE RURAL HEALTH UNIT','','East Poblacion',5,'Alburquerque',1,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000005389','GOV. CELESTINO GALLARES MEMORIAL HOSPITAL','','Poblacion II',946,'Tagbilaran City (Capital)',43,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000005408','LOAY RURAL HEALTH UNIT','','Las Salinas Sur',631,'Loay',29,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000005437','DANAO MOTHER AND CHILD HOSPITAL','','Poblacion',1728,'Danao City',73,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000005444','MABINAY RHU 1 BIRTHING FACILITY','','Poblacion',3362,'Mabinay',147,'Negros Oriental',3,'NIR','','','','','','','','','',''),
('DOH000000000005630','BADIAN DISTRICT HOSPITAL','','Poblacion',1241,'Badian',55,'Cebu',2,'7','','','','','','','','','',''),
('DOH000000000005667','CONGRESSMAN NATALIO P. CASTILLO SENIOR MEMORIAL HOSPITAL','','Canhangdon Occidental',694,'Loon',31,'Bohol',1,'7','','','','','','','','','',''),
('DOH000000000005673','MINGLANILLA DISTRICT HOSPITAL','','Calajo-an',1912,'Minglanilla',82,'Cebu',2,'7','','','','','','','','','','');
/*!40000 ALTER TABLE `a_health_facility_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_management`
--

DROP TABLE IF EXISTS `a_management`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_management` (
  `mngm_id` varchar(50) NOT NULL,
  `patient_id` varchar(50) DEFAULT NULL,
  `mngm_diagnosis` varchar(50) NOT NULL,
  `mngm_diagnosis_date` date NOT NULL,
  `mngm_medication_prescription` text NOT NULL,
  `mngm_followup_date` date DEFAULT NULL,
  `mngm_referral` varchar(50) NOT NULL,
  `mngm_notes` text DEFAULT NULL,
  PRIMARY KEY (`mngm_id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `a_management_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `a_patient_info` (`patient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a_management`
--

LOCK TABLES `a_management` WRITE;
/*!40000 ALTER TABLE `a_management` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_management` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_muncity_info`
--

DROP TABLE IF EXISTS `a_muncity_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_muncity_info` (
  `muncity_id` int(11) NOT NULL,
  `province_id` int(11) DEFAULT NULL,
  `muncity_name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`muncity_id`),
  KEY `province_id` (`province_id`),
  CONSTRAINT `a_muncity_info_ibfk_1` FOREIGN KEY (`province_id`) REFERENCES `a_province_info` (`province_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a_muncity_info`
--

LOCK TABLES `a_muncity_info` WRITE;
/*!40000 ALTER TABLE `a_muncity_info` DISABLE KEYS */;
INSERT INTO `a_muncity_info` VALUES
(1,1,'Alburquerque'),
(2,1,'Alicia'),
(3,1,'Anda'),
(4,1,'Antequera'),
...
/*!40000 ALTER TABLE `a_muncity_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_ncd_risk_factors`
--

DROP TABLE IF EXISTS `a_ncd_risk_factors`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_ncd_risk_factors` (
  `rf_id` varchar(50) NOT NULL,
  `patient_id` varchar(50) DEFAULT NULL,
  `rf_tobacco_use` char(3) DEFAULT NULL,
  `rf_alcohol_intake` char(3) DEFAULT NULL,
  `rf_binge_drinker` char(3) DEFAULT NULL,
  `rf_physical_activity` char(3) DEFAULT NULL,
  `rf_nad_assessment` char(3) DEFAULT NULL,
  `rf_kg_weight` float DEFAULT NULL,
  `rf_cm_height` float DEFAULT NULL,
  `rf_bmi` float DEFAULT NULL,
  `rf_waist_circumference` float DEFAULT NULL,
  `rf_bp` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`rf_id`),
  KEY `patient_id` (`patient_id`),
  CONSTRAINT `a_ncd_risk_factors_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `a_patient_info` (`patient_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a_ncd_risk_factors`
--

LOCK TABLES `a_ncd_risk_factors` WRITE;
/*!40000 ALTER TABLE `a_ncd_risk_factors` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_ncd_risk_factors` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_officer_info`
--

DROP TABLE IF EXISTS `a_officer_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_officer_info` (
  ...
  `officer_mname` varchar(50) DEFAULT NULL,
  `officer_lname` varchar(50) NOT NULL,
  `officer_contact_no` varchar(11) NOT NULL,
  `officer_designation` varchar(50) NOT NULL,
  `officer_is_verified` tinyint(1) NOT NULL,
  `hf_id` varchar(18) NOT NULL,
  PRIMARY KEY (`officer_id`),
  KEY `hf_id` (`hf_id`),
  CONSTRAINT `a_officer_info_ibfk_1` FOREIGN KEY (`hf_id`) REFERENCES `a_health_facility_info` (`hf_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a_officer_info`
--

LOCK TABLES `a_officer_info` WRITE;
/*!40000 ALTER TABLE `a_officer_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_patient_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_province_info`
--

DROP TABLE IF EXISTS `a_province_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_province_info` (
...
--
-- Dumping data for table `a_province_info`
--

LOCK TABLES `a_province_info` WRITE;
/*!40000 ALTER TABLE `a_province_info` DISABLE KEYS */;
INSERT INTO `a_province_info` VALUES
(1,'Bohol',NULL),
(2,'Cebu',NULL),
(3,'Negros Oriental',NULL),
(4,'Siquijor',NULL),
(5,'Negros Occidental',NULL),
(6,'Camotes',NULL),
(7,'Biliran',NULL),
(8,'Leyte',NULL),
(9,'Southern Leyte',NULL),
(10,'Samar',NULL),
(11,'Eastern Samar',NULL),
(12,'Northern Samar',NULL);
/*!40000 ALTER TABLE `a_province_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_referral`
--

DROP TABLE IF EXISTS `a_referral`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_referral` (
  ...
  KEY `officer_id` (`officer_id`),
  KEY `hf_id` (`hf_id`),
  CONSTRAINT `a_referral_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `a_patient_info` (`patient_id`),
  CONSTRAINT `a_referral_ibfk_2` FOREIGN KEY (`officer_id`) REFERENCES `a_officer_info` (`officer_id`),
  CONSTRAINT `a_referral_ibfk_3` FOREIGN KEY (`hf_id`) REFERENCES `a_health_facility_info_OLD` (`hf_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a_referral`
--

LOCK TABLES `a_referral` WRITE;
/*!40000 ALTER TABLE `a_referral` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_superadmin_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_supervisor_info`
--

DROP TABLE IF EXISTS `a_supervisor_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_supervisor_info` (
  ...
  `supervisor_is_verified` tinyint(1) NOT NULL,
  `hf_id` varchar(18) NOT NULL,
  PRIMARY KEY (`supervisor_id`),
  KEY `hf_id` (`hf_id`),
  CONSTRAINT `a_supervisor_info_ibfk_1` FOREIGN KEY (`hf_id`) REFERENCES `a_health_facility_info_OLD` (`hf_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `a_supervisor_info`
--

LOCK TABLES `a_supervisor_info` WRITE;
/*!40000 ALTER TABLE `a_supervisor_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_supervisor_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'e-TsekApp'
--
...
-- Dump completed on 2024-09-23 15:05:42
