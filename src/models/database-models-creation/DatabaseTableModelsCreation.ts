...
export const createTablesScripts = [
  `CREATE TABLE IF NOT EXISTS ${TableNames.BARANGAY_TABLE} (
      barangay_id INT NOT NULL PRIMARY KEY,
  ...
  `CREATE TABLE IF NOT EXISTS ${TableNames.MANAGEMENT_TABLE}(
      ...
      patient_id VARCHAR(50),
      mngm_lifestyle_mod VARCHAR(100),
      mngm_med_antihypertensive VARCHAR(100),
  ...
  `CREATE TABLE IF NOT EXISTS ${TableNames.GENERAL_INFORMATION} (
      id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
      profile_id INT,
      dengvaxia_recipient_no VARCHAR(100),
      respondent INT,
      contact_no VARCHAR(50),
      street_name VARCHAR(121),
      sitio VARCHAR(121),
      religion VARCHAR(100),
      religion_others VARCHAR(100),
  ...
  `CREATE TABLE IF NOT EXISTS ${TableNames.PHIC_MEMBERSHIP} (
      ...
      phic_type VARCHAR(100),
      phic_sponsored VARCHAR(100),
      phic_sponsored_others VARCHAR(100),
      phic_employed VARCHAR(100),
  ...
  `CREATE TABLE IF NOT EXISTS ${TableNames.PROFILE} (
      ...
      phicID VARCHAR(100) NOT NULL,
      nhtsID VARCHAR(100) NOT NULL,
      ...
      other_religion VARCHAR(255),
      contact VARCHAR(255),
      height DOUBLE(8,2),
      weight DOUBLE(8,2),
      cancer VARCHAR(255),
      cancer_type VARCHAR(255),
      mental_med VARCHAR(255),
      tbdots_med VARCHAR(255),
      cvd_med VARCHAR(255),
      covid_status VARCHAR(255),
      menarche VARCHAR(255),
      menarche_age INT,
      newborn_screen VARCHAR(255),
      newborn_text VARCHAR(255),
      deceased VARCHAR(255),
      deceased_date DATE,
      pwd_desc VARCHAR(255),
  ...
  `CREATE TABLE IF NOT EXISTS ${TableNames.TUBERCULOSIS} (
      ...
      updated_at TIMESTAMP,
      tb_ppd INT,
      tb_result_ppd VARCHAR(255),
      tb_sputum_exam INT,
      tb_result_sputum_exam VARCHAR(255),
      tb_cxr INT,
      tb_result_cxr VARCHAR(255),
      tb_genxpert INT,
      tb_result_genxpert VARCHAR(255)
    )`,
];
