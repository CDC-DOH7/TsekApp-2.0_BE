...
import {
  ...
  insertDefaultConsultationTypesValues,
...
const identifyTableName = (index: number) => {
  const tableNamesMap: { [key: number]: string } = {
    ...
    19: TableNames.CONSULTATION_TYPES_TABLE,
    20: TableNames.CONSULTATION_LOGS_TABLE,
    21: TableNames.AGE_BRACKET,
    22: TableNames.AVAILABLE_SERVICES,
    23: TableNames.BRACKET_SERVICES,
    24: TableNames.CASES,
    25: TableNames.FEEDBACK,
    26: TableNames.GENERAL_INFORMATION,
    27: TableNames.IMMUSTAT,
    28: TableNames.MEDICATION,
    29: TableNames.PHIC_MEMBERSHIP,
    30: TableNames.PROFILE,
    31: TableNames.SERVICES,
    32: TableNames.TUBERCULOSIS,
  };
