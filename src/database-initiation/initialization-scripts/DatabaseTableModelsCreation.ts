...
export const createTablesScripts = [
  ...
  `CREATE TABLE IF NOT EXISTS ${TableNames.ASSESS_RED_FLAG_TABLE}(
      ...
      ard_chest_pain VARCHAR(6),
      ard_difficulty_breathing VARCHAR(6),
      ard_loss_consciousness VARCHAR(6),
      ard_slurred_speech VARCHAR(6),
      ard_facial_asymmetry VARCHAR(6),
      ard_numb_arm VARCHAR(6),
      ard_disoriented VARCHAR(6),
      ard_chest_retractions VARCHAR(6),
      ard_seizure_or_convulsion VARCHAR(6),
      ard_selfharm_or_suicide VARCHAR(6),
      ard_aggressive_behavior VARCHAR(6),
      ard_eye_injury VARCHAR(6),
      ard_severe_injuries VARCHAR(6),
  ...
  `CREATE TABLE IF NOT EXISTS ${TableNames.ASSESS_RED_FLAG_SUMMARY_TABLE}(
      red_flag_type VARCHAR(50) NOT NULL,
  ...
  `CREATE TABLE IF NOT EXISTS ${TableNames.PAST_MEDICAL_HISTORY_TABLE}(
      ...
      patient_id VARCHAR(50),
      pmh_hypertension VARCHAR(6),
      pmh_heart_disease VARCHAR(6),
      pmh_diabetes VARCHAR(6),
      pmh_specify_diabetes VARCHAR(50),
      pmh_cancer VARCHAR(6),
      pmh_specify_cancer VARCHAR(50),
      pmh_copd VARCHAR(6),
      pmh_asthma VARCHAR(6),
      pmh_allergies VARCHAR(6),
      pmh_specify_allergy VARCHAR(50),
      pmh_disorders VARCHAR(6),
      pmh_specify_disorder VARCHAR(50),
      pmh_vision_problems VARCHAR(6),
      pmh_previous_surgical_history VARCHAR(6),
      pmh_specify_surgical_history VARCHAR(50),
      pmh_thyroid_disorder VARCHAR(6),
      pmh_kidney_disorder VARCHAR(6),
      FOREIGN KEY (patient_id) REFERENCES a_patient_info(patient_id)
    )`,
  `CREATE TABLE IF NOT EXISTS ${TableNames.FAMILY_HISTORY_TABLE}(
      fh_id VARCHAR(50) NOT NULL PRIMARY KEY,
      patient_id VARCHAR(50),
      fh_hypertension VARCHAR(6),
      fh_stroke VARCHAR(6),
      fh_heart_disease VARCHAR(6),
      fh_diabetes_mellitus VARCHAR(6),
      fh_asthma VARCHAR(6),
      fh_cancer VARCHAR(6),
      fh_kidney_disease VARCHAR(6),
      fh_vascular_disease VARCHAR(6),
      fh_tb VARCHAR(6),
      fh_disorders VARCHAR(6),
      fh_copd VARCHAR(6),
      FOREIGN KEY (patient_id) REFERENCES a_patient_info(patient_id)
    )`,
  `CREATE TABLE IF NOT EXISTS ${TableNames.NCD_RISK_FACTORS_TABLE}(
      ...
      rf_alcohol_intake VARCHAR(6),
      rf_binge_drinker VARCHAR(6),
      rf_physical_activity VARCHAR(6),
      rf_nad_assessment VARCHAR(6),
      rf_kg_weight FLOAT,
      rf_cm_height FLOAT,
      rf_bmi FLOAT,
  ...
  `CREATE TABLE IF NOT EXISTS ${TableNames.RISK_SCREENING_TABLE}(
      ...
      rs_blood_sugar_symptoms VARCHAR(6),
